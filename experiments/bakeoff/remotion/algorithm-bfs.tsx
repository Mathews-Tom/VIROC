// Remotion Skills (agent -> React) -- topic: algorithm-bfs.
...
const NODES: Node[] = [
  { id: "queue", label: "Init Queue", color: "#3b82f6" },
  { id: "dequeue", label: "Dequeue Node", color: "#14b8a6" },
  { id: "visit", label: "Visit Node", color: "#f59e0b" },
  { id: "enqueue", label: "Enqueue Neighbors", color: "#14b8a6" },
  { id: "mark", label: "Mark Visited", color: "#22c55e" },
];

const EDGES: Edge[] = [
  { from: "queue", to: "dequeue", color: "#8b949e" },
  { from: "dequeue", to: "visit", color: "#8b949e" },
  { from: "visit", to: "enqueue", color: "#60a5fa" },
  { from: "enqueue", to: "mark", color: "#4ade80" },
  { from: "mark", to: "dequeue", color: "#8b949e" },
];

const BOX_W = 220;
const BOX_H = 96;
const GAP = 60;
const TITLE = 'Breadth-First Search Traversal';
const NARRATION =
  'Initialize the queue, dequeue a node, visit it, enqueue its neighbors, mark it visited, and loop.';
...
export const AlgorithmBfs: React.FC = () => {
