// Remotion Skills (agent -> React) -- topic: transformer-attention.
...
const NODES: Node[] = [
  { id: "tokens", label: "Input Tokens", color: "#3b82f6" },
  { id: "embeddings", label: "Embeddings", color: "#14b8a6" },
  { id: "qkv", label: "QKV Projections", color: "#a855f7" },
  { id: "scores", label: "Attention Scores", color: "#14b8a6" },
  { id: "context", label: "Context Vectors", color: "#22c55e" },
];

const EDGES: Edge[] = [
  { from: "tokens", to: "embeddings", color: "#34d399" },
  { from: "embeddings", to: "qkv", color: "#60a5fa" },
  { from: "qkv", to: "scores", color: "#f472b6" },
  { from: "scores", to: "context", color: "#fbbf24" },
];

const BOX_W = 220;
const BOX_H = 96;
const GAP = 60;
const TITLE = 'Self-Attention in Transformers';
const NARRATION =
  'Tokens are embedded, projected into queries, keys, and values, scored by similarity, and combined into context vectors.';
...
export const TransformerAttention: React.FC = () => {
