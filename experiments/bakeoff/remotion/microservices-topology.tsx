// Remotion Skills (agent -> React) -- topic: microservices-topology.
...
const NODES: Node[] = [
  { id: "gateway", label: "API Gateway", color: "#f59e0b" },
  { id: "auth", label: "Auth Service", color: "#f59e0b" },
  { id: "orders", label: "Order Service", color: "#f59e0b" },
  { id: "payments", label: "Payment Service", color: "#f59e0b" },
  { id: "db", label: "Database", color: "#22c55e" },
];

const EDGES: Edge[] = [
  { from: "gateway", to: "auth", color: "#8b949e" },
  { from: "gateway", to: "orders", color: "#60a5fa" },
  { from: "orders", to: "payments", color: "#8b949e" },
  { from: "payments", to: "db", color: "#4ade80" },
];

const BOX_W = 220;
const BOX_H = 96;
const GAP = 60;
const TITLE = 'A Microservices Topology';
const NARRATION =
  'The gateway authenticates requests and routes orders through the payment service to the database.';
...
export const MicroservicesTopology: React.FC = () => {
